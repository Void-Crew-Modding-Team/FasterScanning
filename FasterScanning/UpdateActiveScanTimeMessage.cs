...
namespace FasterScanning
{
    internal class UpdateActiveScanTimeMessage : ModMessage
    {
        ...
        {
            Send(MyPluginInfo.PLUGIN_GUID, Instance.GetIdentifier(), NetworkedPeerManager.Instance.NetworkedPeersWithMod(MyPluginInfo.PLUGIN_GUID).ToArray(), new object[] { BepinPlugin.Bindings.ActiveValue }, true);
        }
